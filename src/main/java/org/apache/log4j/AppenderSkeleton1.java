 ...
 * @since 0.8.1
 */
public abstract class AppenderSkeleton1 implements Appender, OptionHandler {
     ...
     * @since 1.2.15
     */
    protected AppenderSkeleton1(final boolean isActive) {
        super();
    }
    ...
    /**
     * Subclasses of <code>AppenderSkeleton1</code> should implement this
     * method to perform actual logging. See also {@link #doAppend
     * AppenderSkeleton1.doAppend} method.
     *
     * @since 0.9.0
     */
    abstract
     ...
     * AppenderSkeleton1#append} method.
     */
    @Override
    public synchronized void doAppend(LoggingEvent event) {
        ...
        // 执行子类append(LoggingEvent event)方法
        this.append(event);
    }
