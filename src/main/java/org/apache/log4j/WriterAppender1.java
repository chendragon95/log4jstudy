 ...
 * @since 1.1
 */
public class WriterAppender1 extends AppenderSkeleton1 {
     ...
     */
    public WriterAppender1(Layout layout, OutputStream os) {
     ...
     * the user.
     */
    public WriterAppender1(Layout layout, Writer writer) {
        this.layout = layout;
    ...
    /**
     * This method is called by the {@link AppenderSkeleton1#doAppend}
     * method.
     *
