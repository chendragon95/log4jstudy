...
public class LogManager1 {
    ...
    static {
        ...
        if (override == null || "false".equalsIgnoreCase(override)) {
            ...
            if (url != null) {
                ...
                try {
                    // 读取配置, 完成logger初始化
                    OptionConverter1.selectAndConfigure(url, configuratorClassName,
    ...
    public void setRepositorySelector(RepositorySelector selector, Object guard)
        ...
        if ((LogManager1.guard != null) && (LogManager1.guard != guard)) {
        ...
        LogManager1.guard = guard;
        LogManager1.repositorySelector = selector;
    }
